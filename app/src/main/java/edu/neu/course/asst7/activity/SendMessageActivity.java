...
public class SendMessageActivity extends AppCompatActivity {
    ...
    private Map<String, Integer> stickers = new HashMap<>();
    ...
    private void getData() {
        ...
        Thread stickerThread = new Thread(() -> stickers = Utils.getStickersMap());
        userThread.start();
        stickerThread.start();
    }
    ...
    public void sendMessageToDevice(View view) {
        ...
        String stickerName = "cool"; // TODO: get the sticker id from user's selection

        new Thread(() -> sendMessageToDevice(recepient, stickerName)).start();
    }
    ...
    private void sendMessageToDevice(User recipient, String stickerName) {
        ...
        try {
            ...
            jNotification.put("body", stickerName);
